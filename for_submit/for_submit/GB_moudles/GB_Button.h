...
#define COMM_BTN_x 50		// command button
...
#define SIZE_BTN_x 300		// command button
...
#define ERASER 2500			// 랜덤 버튼 번호
#define ERASER_BTN_x 600	// command button
#define ERASER_BTN_y 30		//
#define ERASER_BTN_width 60	//
#define ERASER_BTN_hight 35	//
